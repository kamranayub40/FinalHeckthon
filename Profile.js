    ...
    return(
        <>
         <ScrollView  behaviour = "height"
                ...
                style= {{ marginTop: '2%',}}>
        <TextInput value={Name} onChangeText={(Name)=>setName(Name)} placeholder="Enter your FullName" style={styles.input}/>
        <TextInput value={FatherName} onChangeText={(FatherName)=>setFatherName(FatherName)} placeholder="Enter your FatherName" style={styles.input}/>
        <TextInput value={Nic} onChangeText={(nic)=>setNic(nic)} placeholder="Enter your NIC(without Dshes)" style={styles.input}/>
        <TextInput value={Qualification} onChangeText={(Qualification)=>setqualification(Qualification)} placeholder="Enter Last Qualification" style={styles.input}/>
        <TextInput value={nbr} onChangeText={(nbr)=>setNbr(nbr)} placeholder="Enter your MobileNbr" style={styles.input}/>
        <TextInput value={perminentAddress} onChangeText={(perminentAddress)=>setperminentAddress(perminentAddress)} placeholder="Enter your PerminentAddress" style={styles.input}/>
        <TextInput value={Marks} onChangeText={(Marks)=>setmarks(Marks)} placeholder="Enter your Marks(G/CGPA/obtained Marks)" style={styles.input}/>

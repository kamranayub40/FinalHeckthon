...
const CompanyProfile=()=>{
    ...
    const[Eastablished,setEastablished]=useState()
...
//     }
    ...
    return(
        ...
        <TextInput value={HRName} onChangeText={(HRName)=>setHRName(HRName)} placeholder="Enter HR Name" style={styles.input}/>
        <TextInput value={Eastablished} onChangeText={(Eastablished)=>setEastablished(Eastablished)} placeholder="Enter Eastablish Year" style={styles.input}/>

...
function AdminSignUp(props){
    ...
    return(
        ...
        <View style={styles.container}>
            ...
            style={styles.logo}
            /> */}
            <Text style={styles.text}>Wellcome to Admin Account</Text>
            {/* <TextInput
            Value={email}
            ...
            />
            <Forminput
            labelValue={adminpassword}
            onChangeText={(userpassword)=>setadminPassword(userpassword)}
            ...
            <FormButton
            buttonTitle="SignUp"
            onPress={()=>adminregister(adminemail,adminpassword)} />
            {/* <Button title="signUp"
